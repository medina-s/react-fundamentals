    ...
    return(
        <div className='main'>
            <div className='mainDiv'>
                ...
                <p>
                    This app is intended to be a starter/tutorial app for your upcoming project and a learning sandbox for you in months and years
                    to come should you continue to develop software with React. In this application, we will work though some of the basic React
                    concepts, build out some small applications, and then unleash you to build your own applications.
                </p>
                <hr />
                ...
                <ul>
                    ...
                    <li>Refactor the text on this page and make sure this your own project.</li>
