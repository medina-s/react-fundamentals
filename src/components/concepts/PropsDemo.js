    ...
    return(
        <div className='main'>
            <div className='mainDiv'>
                ...
                <FunctionalComponent string='props are cool, right?' function={toggleBackgroundColor} selectedStyle={ backgroundColor }/>
...
FunctionalComponent.defaultProps = {
    string: 'This is wild!',
    function: () => console.log('Can I see in my dev tools?'),
